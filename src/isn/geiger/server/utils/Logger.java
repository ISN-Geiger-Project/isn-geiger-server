...
public class Logger {
    ...
    public void scheduleBy(ScheduledExecutorService scheduler) {
        this.task = scheduler.scheduleWithFixedDelay(new FlushLogger(this),
                5, 5, TimeUnit.MINUTES);
    }

    public class FlushLogger implements Runnable {
